...
cart.forEach((product) => {
  ...
  row.innerHTML = `
        ...
        <td><button class="remove-product bg-red-500 text-white p-1 rounded" data-id="${
          product.id
        }">Remove</button></td>
        <td><form id="change-units"> 
            <input type="number" name="units" id="units" value="${
              product.units
            }" min="1" class="p-1 rounded border border-gray-300">
